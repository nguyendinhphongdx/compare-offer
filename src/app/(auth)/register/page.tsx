    ...
    return (
      <Card className="w-full max-w-md">
        <CardContent className="py-12 text-center space-y-3">
          ...
          <Link href="/login">
            <Button className="mt-4">Về trang đăng nhập</Button>
          </Link>
        </CardContent>
      </Card>
    )
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="text-center space-y-2 pb-4">
        ...
        <p className="text-muted-foreground text-sm">Đăng ký để bắt đầu so sánh offers</p>
      </CardHeader>
        ...
        <form action={handleSubmit} className="space-y-3">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input id="name" name="name" placeholder="Nguyễn Văn A" className="pl-9" required />
            </div>
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input id="password" name="password" type="password" placeholder="Ít nhất 6 ký tự" className="pl-9" required minLength={6} />
            </div>
          </div>
